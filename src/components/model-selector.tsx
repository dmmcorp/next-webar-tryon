...
export default function ModelSelector() {
  ...
  const { loading, error, models, variants } = useProducts();
      ...
      <div className="relative h-full w-full">
        {(step === 0 || model === null) && (
          <div className="py-4">
            ...
            <div className="w-full h-full overflow-auto">
              {loading && (
                <p
                  className="px-5 pb-2 text-sm text-gray-600"
                  aria-live="polite"
                >
                  Loading models…
                </p>
              ...
              {error && !models.length && (
                <p
                  ...
                  aria-live="polite"
                >
                  Failed to load models. Showing defaults.
                </p>
              )}
        ...
        {model && step === 1 && (
          <div className="py-4">
            ...
            {loading && availableVariants.length === 0 && (
              <p className="px-5 pb-2 text-sm text-gray-600" aria-live="polite">
                Loading variants…
              </p>
            )}
            {error && availableVariants.length === 0 && (
              <p className="px-5 pb-2 text-sm text-red-600" aria-live="polite">
                Failed to load variants. Showing defaults.
              </p>
            )}
                    ...
                    <Button
                      ...
                      className={cn(
                        selectedModel?.path === variant.path &&
                          "bg-amber-200/50 border-yellow-50 border-4 rounded-2xl",
